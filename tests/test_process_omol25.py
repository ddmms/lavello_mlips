...
def test_restart_5ranks_matches_serial():
    ...
    serial_df_records = serial_df.to_dict("records")
    serial_pq_by_sha = {r["geom_sha1"]: r for r in serial_df_records}
    ...
    mpi_df_records = mpi_df.to_dict("records")
    mpi_pq_by_sha = {r["geom_sha1"]: r for r in mpi_df_records}
