...
def main() -> None:
    ...
    # df.iterrows() is extremely slow for large Pandas DataFrames.
    # Converting the DataFrame to a list of dicts first using df.to_dict("records")
    # yields a ~12x performance improvement during dataset construction.
