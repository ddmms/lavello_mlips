...
def main() -> None:
    ...
    # Optimization: Convert DataFrame to native Python dictionaries for fast iteration,
    # completely avoiding the massive overhead of Pandas Series creation in df.iterrows()
