...
def main() -> None:
    ...
    # ⚡ Bolt Optimization: Using df.to_dict('records') is significantly faster than df.iterrows()
    # because it avoids creating a new pandas Series object for every single row.
