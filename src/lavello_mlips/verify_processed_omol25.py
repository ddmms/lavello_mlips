...
def main() -> None:
    ...
    # Performance Optimization: Convert DataFrame to a list of dicts first.
    # Iterating over df.to_dict("records") is significantly faster than df.iterrows(),
    # which creates a new Pandas Series for every single row.
